...
<main>
	<div class="bg-primary"><h3>Agregar Producto:</h3>
		<form class="form form-horizontal" action="ServletAdministrarProducto" method="POST">
		...
		<table class="table table-bordered table-hover table-primary">
                    		...
                    		<% for (Producto prod : lp) { %>
                    			<tr>
                    				...
                    				<!-- Modificar -->
                    				<td><form action="ServletModificarProducto" method="GET">
                    					<input type="hidden" name="CodProd" value="<%=prod.getCodProd()%>">
                    					<button class="btn btn-primary" type="submit"> Modificar </button>	
                    				    </form>
                    				</td>
                    				<!-- borrar -->
                    				<td><form action="ServletBorrarProducto" method="POST">
                    					<input type="hidden" name="CodProd" value="<%=prod.getCodProd()%>">
